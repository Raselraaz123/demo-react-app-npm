...
11.Cerate requireAuth commponent ==> check user exists also tract user location
12. In route wrap Protected component by using Require Auth Component
*/

/*
hosting steps
1.npm install -g firebase-tools(one tine for your computer)
2.firebase login (one time for your computer)
3.firebase init(one time for each project)
4.npm run build(every time you want to daploy  )
5.firebase deploy(every time you want to daploy  )
*/